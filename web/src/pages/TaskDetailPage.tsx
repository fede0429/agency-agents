                ...
                <div key={node.step} className="relative z-10">
                  <div className="flex items-start gap-4">
                    <div className={cn(
                      ...
                      node.status === 'success' ? "bg-green-500 border-green-400 text-white" :
                      node.status === 'failed' ? "bg-red-500 border-red-400 text-white" :
                      node.status === 'processing' ? "bg-card border-primary text-primary" :
                      "bg-card border-white/20 text-white/20"
                    )}>
                    ...
                    <div className="flex-1 pb-1">
                      ...
                      {node.status === 'processing' && (
                        <p className="text-xs text-primary mt-1 flex items-center gap-1.5 animate-pulse">
                          <RefreshCw className="w-3 h-3" /> 处理中...
                        </p>
                      )}
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass rounded-xl overflow-hidden border border-white/10">
            <div className="p-4 border-b border-white/5 bg-white/5 flex items-center gap-2">
              ...
              <h3 className="font-medium text-sm">最终合成视频</h3>
            </div>
          ...
          <div className="glass rounded-xl overflow-hidden border border-white/10">
            <div className="p-4 border-b border-white/5 bg-white/5 flex items-center gap-2">
              ...
              <h3 className="font-medium text-sm">解说脚本</h3>
            </div>
